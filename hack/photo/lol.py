...
sound1 = pygame.mixer.Sound('sounds/lox.mp3')
sound2 = pygame.mixer.Sound('sounds/avi.mp3')
...
while running and 0 <= progress <= 1:
    ...
    for teacher in proctor_avinash:
        ...
        if clicked_desk and (
            ...
            # pygame.mixer.music.load('sounds/lox.mp3')
            # pygame.mixer.music.set_volume(0.5)
            # pygame.mixer.music.play(1)
    ...
    if progress == 0:
        final_lost = pygame.image.load('photo/back.png')
    elif progress == 1:
        final_won = pygame.image.load('photo/back.png')
